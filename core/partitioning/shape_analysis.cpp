...
void getSegmentsOutputByRunning(
  ...
  for (auto& input : seg_block.raw_inputs()) {
    LOG_DEBUG("Register input ivalues_maps for torch::jit::Value* " << input->debugName() << ", produced from "
  ...
  for (auto& output : seg_block.raw_outputs()) {
    ...
    LOG_DEBUG("Register output ivalues_maps for torch::jit::Value* " << output->debugName() << ", produced from "
